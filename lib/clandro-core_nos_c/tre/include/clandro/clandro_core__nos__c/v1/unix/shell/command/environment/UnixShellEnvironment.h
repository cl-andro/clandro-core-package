#ifndef LIBCLANDRO_CORE__NOS__C__UNIX_SHELL_ENVIRONMENT___H
#define LIBCLANDRO_CORE__NOS__C__UNIX_SHELL_ENVIRONMENT___H
...
#endif // LIBCLANDRO_CORE__NOS__C__UNIX_SHELL_ENVIRONMENT___H
