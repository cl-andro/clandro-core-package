...
#ifndef LIBCLANDRO_CORE__NOS__C__UNIX_SAFE_STRERROR___H
#define LIBCLANDRO_CORE__NOS__C__UNIX_SAFE_STRERROR___H
...
#endif // LIBCLANDRO_CORE__NOS__C__UNIX_SAFE_STRERROR___H
