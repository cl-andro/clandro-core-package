#ifndef LIBCLANDRO_CORE__NOS__C__FILE_LOGGER_IMPL___H
#define LIBCLANDRO_CORE__NOS__C__FILE_LOGGER_IMPL___H
...
#endif // LIBCLANDRO_CORE__NOS__C__FILE_LOGGER_IMPL___H
