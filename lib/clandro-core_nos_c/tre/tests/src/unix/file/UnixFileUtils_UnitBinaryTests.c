...
void test__absolutizePath__Basic() {
    ...
    // Ensure enough space for 25 char binary under CLANDRO__PREFIX__BIN_DIR for tests.
    state__ATrue(strlen(cwd) + strlen(CLANDRO__PREFIX__BIN_DIR "/xxxxxxxxxxxxxxxxxxxxxxxxx") < PATH_MAX);
...
void test__normalizePath__BinaryPaths() {
    ...
    normalizeP__AEqual__NES(CLANDRO__PREFIX__BIN_DIR "/sh", CLANDRO__PREFIX__BIN_DIR "/sh");
    normalizeP__AEqual__NES(CLANDRO__PREFIX__BIN_DIR "/sh", CLANDRO__PREFIX__BIN_DIR "/../bin/sh");
}
